            ...
            <div class="row pt80">
                <div class="col-lg-6">
                    <div class="page-heading mr25">
                        <span class="sub-heading mb15" data-aos="fade-up" data-aos-delay="200"><i
                                class="fas fa-building mr5"></i> Who We Are</span>
                        <h1 data-aos="fade-up" data-aos-delay="400"> We are a <span
                                class="bym-text rt45">creative</span> digital agency based in India.</h1>
                        <p class="mt30 h-light" data-aos="fade-up" data-aos-delay="600">We are a team of top talent
                            delivering enterprise solutions globally. we evolve with the advancement in technology
                            because we believe in making our technology as your innovation.</p>
                        <p class="mt15 h-light" data-aos="fade-up" data-aos-delay="800">Our experts provide a wide range
                            of services including app design, web development, digital marketing, ecommerce solutions
                            and cloud development. We stay updated with the technology to build innovative digital
                            products that meet client requirements across multiple business verticals and domains by
                            housing some of the best professionals in the industry.</p>
                    </div>
                </div>

                <div class="col-lg-6">
                    <div class="sol-img m-mt30">
                        <img src="images/others/building-mockup.jpg" alt="" class="img-fluid"
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="page-headings side-pghd">
                        <span class="sub-heading mb15">About Buy Your Mart?</span>
                        <h2>The Buy Your Mart</h2>
                    </div>
                </div>
                <div class="col-lg-8">
                    <h4 class="mb15">Buy Your Mart is a full-service web, app and digital marketing company based in India.
                    </h4>
                    ...
                    <p class="mt15">To learn more about our approach to business and work, feel free to hop on over to
                        our Open Contact Page.</p>

                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="company-stats2 roww mt30">
                                <div class="statsnum counter-number mt30">
                                    <p>Complete Projects</p> <span class="counter">7500</span> <span>+</span>
                                </div>
                                <div class="statsnum counter-number mt30">
                                    <p>Happy Clients</p> <span class="counter">3500</span> <span>+</span>
                                </div>
                                <div class="statsnum counter-number mt30">
                                    <p>Expert Team</p> <span class="counter">540</span><span>+</span>
                                </div>
                                <div class="statsnum counter-number mt30">
                ...
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 mt30">
                            <div class="bym-card ico-cont">
                                <div class="ic-img mb20"> <img src="images/icons/topseobrands01.png" alt="Award Buy Your Mart">
                                </div>
                                <div class="ic-cont">
                        ...
                        <div class="col-lg-6 col-sm-6 mt30">
                            <div class="bym-card ico-cont">
                                <div class="ic-img mb20"> <img src="images/icons/extract01.png" alt="Award Buy Your Mart">
                                </div>
                                <div class="ic-cont">
                        ...
                        <div class="col-lg-6 col-sm-6 mt30">
                            <div class="bym-card ico-cont">
                                <div class="ic-img mb20"> <img src="images/icons/designrush01.png" alt="Award Buy Your Mart">
                                </div>
                                <div class="ic-cont">
                        ...
                        <div class="col-lg-6 col-sm-6 mt30">
                            <div class="bym-card ico-cont">
                                <div class="ic-img mb20"> <img src="images/icons/clutch01.png" alt="Award Buy Your Mart">
                                </div>
                                <div class="ic-cont">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7 text-center">
                    <div class="page-headings">
                        ...
                        <p class="mt15">Lipsum dolor sit amet, consectetur adipisicing elit. sed do eiusmod tempor
            ...
            <div class="row mt30">
                <div class="col-lg-4 col-sm-6">
                    <div class="bym-card r-bg-c mt60">
                        <div class="bym-card-img"><img src="images/icons/target.svg" alt="services"> </div>
                        <div class="bym-card-content mt40">
                            <h3 class="mb15">Client-centric Approach</h3>
                            <p>Our software house has been recognised by google for outstanding android application
                                quality.</p>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="bym-card r-bg-c mt60">
                        <div class="bym-card-img"><img src="images/icons/fast-time.svg" alt="services"> </div>
                        <div class="bym-card-content mt40">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="bym-card r-bg-c mt60">
                        <div class="bym-card-img"><img src="images/icons/united.svg" alt="services"> </div>
                        <div class="bym-card-content mt40">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="bym-card r-bg-c mt60">
                        <div class="bym-card-img"><img src="images/icons/team.svg" alt="services"> </div>
                        <div class="bym-card-content mt40">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="bym-card r-bg-c mt60">
                        <div class="bym-card-img"><img src="images/icons/partnership.svg" alt="services"> </div>
                        <div class="bym-card-content mt40">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="bym-card r-bg-c mt60">
                        <div class="bym-card-img"><img src="images/icons/qualitys.svg" alt="services"> </div>
                        <div class="bym-card-content mt40">
                ...
                <div class="row">
                    <div class="col-lg-6 vcenter">
                        <div class="cta-heading">
                            ...
                            <h2><span class="bym-text rt40">Teamwork</span> is the ability to work together toward a
                                common vision.</h2>

                            <a href="get-quote.html" class="bym-btn  bym-btn-grdt1 mt40 mw-80">Join Our Team <i
