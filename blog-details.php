...
<div class="r-bg-x pb120">
    <div class="container w-992">
        <div class="blog-details">
            <div class="row">
                <div class="col-lg-12">
                    <div class="sol-img mt60"><img src="images/blogs/blog-details-1.jpg" alt="blog" class="img-fluid">
                    </div>
                    <div class="bym-blog-details">
                        <div class="info-bar">
                    ...
                    <div class="center-btn"> <a href="blog.html" class="bym-btn  bym-btn-grdt2 mr20">Back to Blogs
                            <i class="fas fa-arrow-left fa-btn"></i></a> </div>
